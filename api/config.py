"""
Configuration module for CLAP system (serverless version)
"""
import os
...
class Config:
    ...
    # Flask Configuration (not used in serverless, but kept for compatibility)
    SECRET_KEY = os.getenv('SECRET_KEY', 'dev-secret-key-change-in-production')
    FLASK_ENV = os.getenv('FLASK_ENV', 'development')
    DEBUG = os.getenv('FLASK_DEBUG', 'True') == 'True'
    
    # Database Configuration (not used in CSV mode)
    ...
    # Database URI (not used in CSV mode)
